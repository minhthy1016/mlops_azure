...
data_sample = PandasParameterType(pd.DataFrame({"AGE": pd.Series([0], dtype="int8"), "SEX": pd.Series([0], dtype="int8"), "BMI": pd.Series([0.0], dtype="float32"), "BP": pd.Series([0.0], dtype="float32"), "S1": pd.Series([0], dtype="int16"), "S2": pd.Series([0.0], dtype="float32"), "S3": pd.Series([0.0], dtype="float32"), "S4": pd.Series([0.0], dtype="float32"), "S5": pd.Series([0.0], dtype="float32"), "S6": pd.Series([0], dtype="int8")}))
