...
#import lightgbm, RandomForestRegressor
...
def train_eval(X_train, y_train, X_test, y_test):
    train_data = RandomForestRegressor.Dataset(X_train, label=y_train)
    valid_data = RandomForestRegressor.Dataset(X_test, label=y_test, free_raw_data=False)
